...
export default function DealDossier({ property, onClose }: Props) {
  ...
  return (
    <>
      ...
      <div
        ref={drawerRef}
        className="fixed top-0 right-0 h-full w-full max-w-xl bg-[#0a0a0f] border-l border-slate-800 z-50 flex flex-col shadow-2xl"
      >
        {/* Drawer header */}
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <div className="text-slate-500 text-xs truncate max-w-[260px]">{property.address}</div>
              </div>
            </div>
